const products = [
  // Fruits
  {
    ...
    category: "fruits",
    image:
      "https://plus.unsplash.com/premium_photo-1724249990837-f6dfcb7f3eaa?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8YXBwbGV8ZW58MHx8MHx8fDA%3D",
    unit: "per kg",
...
function renderRecipes() {
  // Recipe images (can be replaced with your own URLs)
  const recipeImages = {
    "Fresh Garden Salad":
